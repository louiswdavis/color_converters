...
Gem::Specification.new do |spec|
  ...
  spec.metadata['source_code_uri'] = 'https://github.com/louiswdavis/color_converter'
  spec.metadata['changelog_uri'] = 'https://github.com/louiswdavis/color_converter/blob/master/CHANGELOG.md'
