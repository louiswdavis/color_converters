...
RSpec.describe ColorConversion::XyzConverter do
  context 'methods' do
    ...
    it '.validate_input' do
      expect { described_class.new(x: 174, y: 35, z: 37) }.to raise_error(ColorConversion::InvalidColorError)
      expect { described_class.new(x: 74, y: 135, z: 37) }.to raise_error(ColorConversion::InvalidColorError)
      expect { described_class.new(x: 74, y: 35, z: 137) }.to raise_error(ColorConversion::InvalidColorError)
    end
