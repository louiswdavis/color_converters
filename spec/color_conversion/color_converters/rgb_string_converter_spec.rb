...
RSpec.describe ColorConversion::RgbStringConverter do
  context 'methods' do
    it '.matches?' do
    ...
    it '.input_to_rgba' do
      ...
      expect { described_class.new('rgba(51, 102)').rgba }.to raise_error(ColorConversion::InvalidColorError)
      expect { described_class.new('rgba(foo)').rgba }.to raise_error(ColorConversion::InvalidColorError)
    end
  end
end
