...
RSpec.describe ColorConversion::HslStringConverter do
  context 'methods' do
    ...
    it '.input_to_rgba' do
      ...
      expect { described_class.new('hsl(51, 102)').rgba }.to raise_error(ColorConversion::InvalidColorError)
      expect { described_class.new('hsla(foo)').rgba }.to raise_error(ColorConversion::InvalidColorError)
    end
  end
end
