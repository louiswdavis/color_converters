...
RSpec.describe ColorConverter::BaseConverter do
  context 'methods' do
    it 'conversions' do
      color = ColorConverter::Color.new(r: 51, g: 102, b: 204, a: 0.8)
      ...
      color = ColorConverter::Color.new(r: 64, g: 104, b: 193)
      ...
      color = ColorConverter::Color.new(r: 255, g: 255, b: 255)
      expect(color.xyz).to eq({ x: 95.05, y: 100.0, z: 108.88 })

      color = ColorConverter::Color.new(r: 0, g: 0, b: 0)
      expect(color.xyz).to eq({ x: 0.0, y: 0.0, z: 0.0 })
      expect(color.name).to eq 'black'

      color = ColorConverter::Color.new(r: 1, g: 1, b: 1)
      ...
      color = ColorConverter::Color.new(r: 140, g: 76, b: 201)
      ...
      color = ColorConverter::Color.new(r: 255, g: 0, b: 197)
