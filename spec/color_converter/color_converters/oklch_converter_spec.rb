...
RSpec.describe ColorConverter::OklchConverter do
  context 'methods' do
    it '.matches?' do
    ...
    it '.validate_input' do
      expect { described_class.new(l: 174, c: 35, h: 37) }.to raise_error(ColorConverter::InvalidColorError)
      expect { described_class.new(l: 74, c: 135, h: 37) }.to raise_error(ColorConverter::InvalidColorError)
      expect { described_class.new(l: 74, c: 35, h: 437) }.to raise_error(ColorConverter::InvalidColorError)
    end
