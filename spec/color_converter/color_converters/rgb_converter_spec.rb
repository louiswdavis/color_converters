...
RSpec.describe ColorConverter::RgbConverter do
  context 'methods' do
    it '.matches?' do
    ...
    it '.validate_input' do
      expect { described_class.new(r: 274, g: 35, b: 37) }.to raise_error(ColorConverter::InvalidColorError)
      expect { described_class.new(r: 74, g: -35, b: 37) }.to raise_error(ColorConverter::InvalidColorError)
      expect { described_class.new(r: 74, g: 35, b: 337) }.to raise_error(ColorConverter::InvalidColorError)
    end
