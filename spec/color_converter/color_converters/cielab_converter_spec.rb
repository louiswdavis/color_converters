...
RSpec.describe ColorConverter::CielabConverter do
  context 'methods' do
    it '.matches?' do
    ...
    it '.validate_input' do
      expect { described_class.new(l: 274, a: 35, b: 37) }.to raise_error(ColorConverter::InvalidColorError)
      expect { described_class.new(l: 74, a: 235, b: 37) }.to raise_error(ColorConverter::InvalidColorError)
      expect { described_class.new(l: 74, a: 35, b: 237) }.to raise_error(ColorConverter::InvalidColorError)
    end
