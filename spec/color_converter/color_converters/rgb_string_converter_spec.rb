...
RSpec.describe ColorConverter::RgbStringConverter do
  context 'methods' do
    it '.matches?' do
    ...
    it '.input_to_rgba' do
      ...
      expect { described_class.new('rgb(51, 102)').rgba }.to raise_error(ColorConverter::InvalidColorError)
      expect { described_class.new('rgba(foo)').rgba }.to raise_error(ColorConverter::InvalidColorError)
    end
  end
end
